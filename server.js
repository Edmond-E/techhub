...
const dbLink = `mongodb+srv://${process.env.NAME}:${process.env.PASSWORD}@cluster0.6gvhbgg.mongodb.net/${process.env.DB}`
...
//     const user = await regSchema.find()((user,regSchema) =>{})
...
//     try {
//         const {email, password} = req.body
//         const userID = await regSchema.find()({email})
//        const validUser = await bcrypt.compare(password,userID.password)
//        if(validUser){
//         const userEmail = userID.email
//         const userFirstName = userID.firstname
